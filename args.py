...
def get_args():
    ...
    parser.add_argument("--img_dir", type=str, default="./images", help="Path to raw images")
    parser.add_argument("--label_dir", type=str, default="./labels", help="Path to raw labels")
